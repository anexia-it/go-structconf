...
// Source: github.com/anexia-it/go-structconf (interfaces: Encoding)
...
func (_m *MockEncoding) MarshalFrom(_param0 interface{}) ([]byte, error) {
...
func (_m *MockEncoding) UnmarshalTo(_param0 []byte, _param1 interface{}) error {
